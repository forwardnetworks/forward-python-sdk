...
class TestUserEvents:
    def test_streams_typed_events_and_filters(self, recorder: Recorder) -> None:
        body = (
            ":ping\n\n"
        ...
        with make_client(recorder) as client:
            everything = [e for e in client.user_events.stream()]
            only = [e for e in client.user_events.stream(types={"CHANGE_SET_DELETED"})]
