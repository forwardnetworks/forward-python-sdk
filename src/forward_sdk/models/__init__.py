...
from forward_sdk._generated.models import (
    ...
    ConnectionType,
    ConnectivityDetails,
    ConnectivityDetailsRequest,
    ConnectivityDetailsValue,
    ConnectivityLevel,
    ConnectivityTestError,
    Context,
    CoveredTopology,
    CoveredTopologyHostGroup,
    CoveredTopologyNode,
    ...
    DraftChangePage,
    DstIpLocationType,
    DynamicConnectionsComputeError,
    Encryptor,
    EncryptorConnection,
    EncryptorList,
    EncryptorPatch,
    ...
    HopLocationFilter9,
    HostAliasFilter,
    HostConnectivityDetails,
    HostConnectivityInfo,
    HostFilter,
    HostsAliasBuilder,
    HostsExposureResponse,
    HttpAuthStrategy,
    HttpCredential,
    HttpCredentialType,
    ...
    InternetConnectionSuggestion,
    InternetConnectionSuggestions,
    InternetExposure,
    InternetNode,
    InternetNodePatch,
    IntranetNode,
    ...
    L2VpnConnection,
    L2VpnConnections,
    L2VpnDynamicConnectionsComputeResult,
    L2VpnList,
    L2VpnPatch,
    L3DynamicConnectionsComputeResult,
    ...
    NqeExecutionStatus,
    NqeExecutionStatusWithResultKey,
    NqeMetricPreview,
    NqeMetricPreviewResult,
    NqePanel,
    NqePanelDef,
    NqePanelIds,
    NqePanelMetrics,
    ...
    ScopedUserObject,
    SearchIntent,
    SecurityMatrixConnectivity,
    SecurityMatrixFilter,
    SecurityMatrixFiltersList,
    SecurityMatrixFilterUpdate,
    SecurityMatrixFilterWithUsers,
    ...
    SyntheticNatEntry,
    Tags,
    TapiNetworkContainer,
    TapiNetworkContainerList,
    TenableInfo,
    TextPosition,
    TextRegion,
    ThresholdRule,
...
from forward_sdk._generated.models import Type45 as DiffEntryType
