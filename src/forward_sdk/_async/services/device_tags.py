...
__all__ = ["AsyncDeviceTagsService"]


class AsyncDeviceTagsService(AsyncService):
    ...
    async def get(
        ...
        return dict(await self._send_json(spec) or {})

    async def create(
        self, tag: Mapping[str, Any], *, network_id: str | None = None
    ) -> dict[str, Any]:
        """Create a tag."""
        payload = await self._send_json(
            ops.add_device_tag(network_id=self._network(network_id), tag=tag)
        )
    ...
    async def create_many(
        ...
        return await self._send_json(
            ops.add_device_tags(network_id=self._network(network_id), tags=tags)
        )
    ...
    async def delete(self, tag_name: str, *, network_id: str | None = None) -> None:
        await self._send_json(
            ops.delete_device_tag(network_id=self._network(network_id), tag_name=tag_name)
        )

    async def add_to_devices(
    ...
    async def add_tags_to_devices(self, body: Any, *, network_id: str | None = None) -> Any:
    ...
    async def remove_tags_from_devices(self, body: Any, *, network_id: str | None = None) -> Any:
    ...
    async def remove_all_from_devices(
    ...
    async def replace_all_for_devices(self, body: Any, *, network_id: str | None = None) -> Any:
